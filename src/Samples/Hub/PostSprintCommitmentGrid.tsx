...
export interface PostSprintCommitmentGridState {
    workItems: WorkItem[];
}

export interface PostSprintCommitmentGridProps {
    project: IProjectInfo | undefined;
    iteration: Iteration | undefined;
    team: Team | undefined;
}

export class PostSprintCommitmentGrid extends React.Component<PostSprintCommitmentGridProps, PostSprintCommitmentGridState> {
    private project? : IProjectInfo;
    private iteration? : Iteration;
    private team? : Team;

    constructor(props: PostSprintCommitmentGridProps) {
        super(props);
    ...
    public componentWillReceiveProps(props : PostSprintCommitmentGridProps) {
        console.debug("PostSprintCommitmentGrid: componentWillReceiveProps");
        console.debug(props);
    ...
    private async initializeState() {
        console.debug("PostSprintCommitment: initializeState");
        ...
        console.debug("PostSprintCommitment: initializeState with project and team");
        ...
        console.debug("PostSprintCommitment: fetched teamFieldValues")
